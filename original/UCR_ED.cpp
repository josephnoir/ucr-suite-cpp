...
/// Comparison function for sorting the query. The query will be sorted
/// by absolute z-normalization value, |z_norm(Q[i])| from high to low.
...
/// |z_norm(Q[i])|
// double distance(const double * const Q, const double * const T , const int& j
// , const int& m , const double& mean , const double& std , const int* const
// order, const double& bsf)
